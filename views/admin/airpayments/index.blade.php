                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('airpayments.destroy',$airpayment->id) }}" method="Post">
                                <a class="btn btn-primary" style="padding: 1px 6px;" href="{{ route('airpayments.edit',$airpayment->id) }}">Edit</a>
                                <a class="btn btn-secondary" style="padding: 1px 6px;" href="{{ route('airpayments.show',$airpayment->id) }}">View</a>
                                @csrf
                                @method('DELETE')
